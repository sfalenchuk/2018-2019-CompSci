...
def onmars ():
	choice = input("You go out into the Martian desert, and slowly begin to gather up your supplies. You suddenly see something in the distance, and it looks like your food supplies. Do you 1) Go after it or 2) return back to your ship")
